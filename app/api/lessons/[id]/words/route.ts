...
async function tagWord(hebrew: string, english: string): Promise<Tagging> {
  const fallback: Tagging = {
    pos: 'other', gender: null, binyan: null, root: null, hebrew_infinitive: null, english_infinitive: null, conjugations: null,
  }
...
export async function POST(
  ...
  if (tagging.english_infinitive) {
    english = tagging.english_infinitive
  }
